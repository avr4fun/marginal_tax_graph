...
wages = st.sidebar.number_input("Income/Withdrawls ($)", key="wages", step=1000.0)
# Long-term capital gains input
ltcg_input = st.sidebar.number_input("Capital Gains ($)", value=20000, step=1000)
...
ax.stackplot(
    ...
    labels=['Ordinary', 'Capital Gains', 'Social Security', 'Senior Phase-out', 'NIIT'], 
